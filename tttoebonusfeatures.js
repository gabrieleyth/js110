...
// joinOR bonus features modifications start
...
// joinOR bonus features modifications end
...
// small change here: naming the outer while loop
gameLoop: while (true) {
  ...
  // Play again bonus features modifications start
  playAgainLoop: while (true) {
    prompt('Play again?');
    let answer = readline.question().toLowerCase();
  
    if (answer === "y") {
      break playAgainLoop; // breaks out of this loop but overall loop remains true
    } else if (answer === 'n') {
      break gameLoop; // breaks out of both loop
    } else {
      false; // makes you start over playAgainLoop
      prompt("Please enter valid input");
    }
  }
  // Play again bonus features modifications end
}
